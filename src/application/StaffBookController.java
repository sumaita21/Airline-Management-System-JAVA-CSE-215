...
public class StaffBookController implements Initializable {
    ...
    private static final double STAFF_DISCOUNT = 70.0;
    ...
    private void handleClassSelected(ActionEvent e) {
        ...
        double finalPrice = originalPrice * (1 - STAFF_DISCOUNT / 100);
    ...
    private void handleConfirmBooking(ActionEvent event) {
        ...
        Session.discountPercent = STAFF_DISCOUNT;
        Session.finalPrice      = originalPrice * (1 - STAFF_DISCOUNT / 100);
